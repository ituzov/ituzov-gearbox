...
Платформы: **macOS, Linux, Windows через WSL**. На чистой Windows без WSL не заведётся: вся механика стоит на tmux, а он там не живёт. В WSL всё работает, окошко откроется в твоём виндовом Chrome.
